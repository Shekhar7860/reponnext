...
import StudentCourseCancelledDetails from "../../../../../components/layout/student-course/StudentCourseCancelledDetails"
import TeacherCourseCancelledDetails from "../../../../../components/layout/teacher/TeacherCourseCancelledDetails"
        ...
        <Container>
            ...
            <div class="layout-content">
                {(props.user_info ? props.user_info.user.user_type : 0) === 1 ?
                    <StudentCourseCancelledDetails router={router} {...props} />
                    :
                    <TeacherCourseCancelledDetails router={router} {...props} />
                }
            </div>
            <Footer />
