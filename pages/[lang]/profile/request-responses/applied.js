...
import AppliedProfileRequestResponsesLayout from "../../../../components/layout/profile/AppliedProfileRequestResponsesLayout"
                    ...
                    <div class="profile">
                        <div class="container">
                            <div class="row gx-md-5 justify-content-center">
                                <ProfileSidebar router={router} activeTab={"request_reponse"} subActiveTab={"applied"} setLocalProfileIcon={setLocalProfileIcon} logOut={logOut} {...props} />
                                ...
                                <div class="col-lg-9">
                                    ...
                                    <div class="tab-content" id="v-pills-tabContent">
                                        <div class="tab-pane fade show active" id="v-pills-post" role="tabpanel" aria-labelledby="v-pills-post-tab">
                                            <AppliedProfileRequestResponsesLayout router={router} {...props} />
                                        </div>
                                    </div>
                                </div>
...
ProfileRequestPage.getInitialProps = async ctx => {
    console.log("ProfileRequestPage getInitialProps called");
