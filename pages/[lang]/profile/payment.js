...
import PaymentProfileLayout from "../../../components/layout/profile/PaymentProfileLayout"
                    ...
                    <div class="profile">
                        <div class="container">
                            <div class="row gx-md-5 justify-content-center">
                                <ProfileSidebar router={router} activeTab={"payment"} setLocalProfileIcon={setLocalProfileIcon} logOut={logOut}{...props} />
                                ...
                                <div class="col-lg-9">
                                    ...
                                    <div class="tab-content" id="v-pills-tabContent">
                                        <div class="tab-pane fade show active" id="v-pills-post" role="tabpanel" aria-labelledby="v-pills-post-tab">
                                            <PaymentProfileLayout router={router} {...props} />
                                        </div>
                                    </div>
                                </div>
