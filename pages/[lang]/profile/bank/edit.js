...
import BankLayout from "../../../../components/layout/profile/bank/BankLayout"
import BankLayoutEdit from "../../../../components/layout/profile/bank/BankLayoutEdit"
                    ...
                    <div class="profile">
                        <div class="container">
                            <div class="row gx-md-5 justify-content-center">
                                <ProfileSidebar router={router} activeTab={"bank"} setLocalProfileIcon={setLocalProfileIcon} logOut={logOut} {...props} />
                                ...
                                <div class="col-lg-9">
                                    ...
                                    <div class="tab-content" id="v-pills-tabContent">
                                        <div class="tab-pane fade show active" id="v-pills-post" role="tabpanel" aria-labelledby="v-pills-post-tab">
                                            <BankLayoutEdit router={router} {...props} />
                                        </div>
                                    </div>
                                </div>
