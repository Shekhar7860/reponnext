...
import ChangePasswordProfileLayout from "../../../components/layout/profile/ChangePasswordProfileLayout"
                    ...
                    <div class="profile">
                        <div class="container">
                            <div class="row gx-md-5 justify-content-center">
                                <ProfileSidebar router={router} setLocalProfileIcon={setLocalProfileIcon} activeTab={"changePassword"} logOut={logOut} {...props} />
                                ...
                                <div class="col-lg-9">
                                    ...
                                    <div class="tab-content" id="v-pills-tabContent">
                                        <div class="tab-pane fade show active" id="v-pills-post" role="tabpanel" aria-labelledby="v-pills-post-tab">
                                            <ChangePasswordProfileLayout router={router} {...props} />
                                        </div>
                                    </div>
                                </div>
...
ProfileChangePasswordPage.getInitialProps = async ctx => {
    console.log("ProfileChangePasswordPage getInitialProps called");
