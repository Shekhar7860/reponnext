...
import PendingPaymentProfileMyCoursesLayout from "../../../../components/layout/profile/PendingPaymentProfileMyCoursesLayout"
import PendingPaymentProfileMyStudentLayout from "../../../../components/layout/profile/PendingPaymentProfileMyStudentLayout"
                    ...
                    <div class="profile">
                        <div class="container">
                            <div class="row gx-md-5 justify-content-center">
                                <ProfileSidebar router={router} activeTab={"myCourses"} subActiveTab={"pending_payment"} setLocalProfileIcon={setLocalProfileIcon} logOut={logOut} {...props} />
                                    ...
                                    <div class="tab-content" id="v-pills-tabContent">
                                        <div class="tab-pane fade show active" id="v-pills-post" role="tabpanel" aria-labelledby="v-pills-post-tab">
                                            {(props.user_info ? props.user_info.user.user_type : 0) === 1 ?
                                                <PendingPaymentProfileMyCoursesLayout router={router} {...props} />
                                                : <PendingPaymentProfileMyStudentLayout router={router} {...props} />}
                                        </div>
                                    </div>
                                </div>
