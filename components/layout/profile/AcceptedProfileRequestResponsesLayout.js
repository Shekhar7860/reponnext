...
class AcceptedProfileRequestResponsesLayout extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
    ...
    initialiseFilter = async (query) => {
        const items = await agent.Teacher.acceptedReqRes(query)
...
export default AcceptedProfileRequestResponsesLayout