...
class AppliedProfileRequestResponsesLayout extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
    ...
    initialiseFilter = async (query) => {
        const items = await agent.Teacher.appliedReqRes(query)
...
export default AppliedProfileRequestResponsesLayout