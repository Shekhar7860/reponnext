...
class RequestProfileMyCoursesLayout extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
    ...
    initialiseFilter = async (query) => {
        const items = await agent.Teacher.myCoursesPending(query)
...
export default RequestProfileMyCoursesLayout