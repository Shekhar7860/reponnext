...
class CancelledProfileMyStudentLayout extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
                    ...
                    <div class="col-xl-10 col-md-8">
                        <div class="card-second h-100 d-flex flex-column justify-content-center">
                            ...
                            <div class="d-flex justify-content-between align-items-end flex-wrap">
                                ...
                                <div>
                                    <button type="button" class="btn btn-outline-primary px-4 me-4 mt-2" onClick={() => this.goToLink(`my-courses/cancelled/${element.id}`)}>View Details</button>
    ...
    initialiseFilter = async (query) => {
        const items = await agent.Teacher.myCoursesDecline(query)
    ...
    render() {
        ...
        return (populerFilterCount !== 0) ? <>
            <div class="main-heading mb-5">
                <h2 class="sub-heading mb-0 fs-24">My Student / Cancelled</h2>
            </div>
            {this.getRowList()}
...
export default CancelledProfileMyStudentLayout