...
class CompletedProfileMyCoursesTeacherLayout extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            ...
            rowDate.push(<div key={index} class="card mt-4">
                <div class="row align-items-center g-0">
                    <div class="col-xl-2 col-md-4">
                        <img class="course-profile" src={this.getProfileIcon(element.student_profile_image)} alt={element.student_profile_image} />
                    </div>
                        ...
                        <div class="card-second h-100 d-flex flex-column justify-content-center">
                            ...
                            <div class="d-flex justify-content-between align-items-end flex-wrap">
                                <div class="mt-2">
                                    ...
                                    <b><span class="text-light fw-500">Student's Name :</span>{capitalizeFirstLetter(element.student_first_name)} {capitalizeFirstLetter(element.student_last_name)}</b>
                                </div>
                                <div>
                                    <button type="button" class="btn btn-outline-primary px-4 me-4 mt-2" onClick={() => this.goToLink(`my-courses/completed/${element.id}`)}>View Details</button>
    ...
    initialiseFilter = async (query) => {
        const items = await agent.Teacher.myCoursesCompleted(query)
    ...
    render() {
        ...
        return (populerFilterCount !== 0) ? <>
            <div class="main-heading mb-5">
                <h2 class="sub-heading mb-0 fs-24">My Student / Completed</h2>
            </div>
            {this.getRowList()}
...
export default CompletedProfileMyCoursesTeacherLayout