...
class OnGoingProfileMyCoursesTeacherLayout extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
                        ...
                        <div class="card-second h-100 d-flex flex-column justify-content-center">
                            ...
                            <div class="d-flex justify-content-between align-items-end flex-wrap">
                                <div class="mt-2">
                                    ...
                                    <b><span class="text-light fw-500">Student's Name :</span>{capitalizeFirstLetter(element.student_first_name)} {capitalizeFirstLetter(element.student_first_name)}</b>
                                </div>
                                <div>
    ...
    initialiseFilter = async (query) => {
        const items = await agent.Teacher.myCoursesOnGoing(query)
    ...
    render() {
        ...
        return (populerFilterCount !== 0) ? <>
            <div class="main-heading mb-5">
                <h2 class="sub-heading mb-0 fs-24">My Student / Ongoing</h2>
            </div>
            {this.getRowList()}
...
export default OnGoingProfileMyCoursesTeacherLayout