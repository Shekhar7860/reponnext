...
class TeacherCoursePendingPaymentDetails extends React.Component {
    ...
    render() {
        // console.log("TeacherCoursePendingPaymentDetails state", this.state);
...
export default TeacherCoursePendingPaymentDetails