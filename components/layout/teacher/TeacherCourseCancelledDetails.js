...
class TeacherCourseCancelledDetails extends React.Component {
    ...
    render() {
        // console.log("TeacherCourseCancelledDetails state", this.state);
...
export default TeacherCourseCancelledDetails