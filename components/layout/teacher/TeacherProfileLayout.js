...
class TeacherProfileLayout extends React.Component {
    ...
    getListOfPosts = (list) => {
        let rowData = []
        list.forEach(element => {
            console.log("getListOfPosts element", element);
            rowData.push(<div className="cursor-pointer" onClick={() => { this.props.router.push(`${this.props.userDetail.id}/post/${element.id}`) }}>
    ...
    render() {
        ...
        const { userDetail, posts, reviews, languages, academics, certificates } = this.props
                    ...
                    <div class="container">
                        <div class="my-5">
                            ...
                            <div class="mt-4">
                                <div class="d-flex justify-content-between flex-wrap">
                                    <div class="main-heading me-4 mt-4">
                                        <h2 class="sub-heading mb-0 fs-24">Posts</h2>
                                    </div>
                                    <span class="text-primary cursor-pointer space-nowrap fs-18 mt-4">View All<i class="fas fa-chevron-right fs-12 ms-2"></i></span>
                                </div>
                                <div class="mt-4">
                                    <Slider {...settings}>
                                        {this.getListOfPosts(posts ? posts : [])}
                                    </Slider>
                                </div>
                            </div>
