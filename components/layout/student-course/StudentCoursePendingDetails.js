...
class StudentCoursePendingDetails extends React.Component {
    ...
    render() {
        console.log("StudentCoursePendingDetails state", this.state);
                        ...
                        <div class="row g-lg-5">
                            ...
                            <div class="col-auto pt-5">
                                <div class="overflow-section">
                                    {(accepted_time_slots ? accepted_time_slots.length : 0) > 0 ?
                                        ...
                                        : <></>}
                                    {(pending_time_slots ? pending_time_slots.length : 0) > 0 ?
                                        <div class="card mt-4 shadow-lg">
                                            <div class="card-body">
                                                <h5>Pending Class</h5>
                                                {this.createTimeSchedule(pending_time_slots ? pending_time_slots : [])}

                                            </div>
                                        </div>
                                        : <></>}
                                    {(cancelled_time_slots ? cancelled_time_slots.length : 0) > 0 ?
                                        <div class="card mt-4 shadow-lg">
                                            <div class="card-body">
...
export default StudentCoursePendingDetails