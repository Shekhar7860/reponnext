...
class StudentCourseCancelledDetails extends React.Component {
    ...
    render() {
        console.log("StudentCourseCancelledDetails state", this.state);
...
export default StudentCourseCancelledDetails