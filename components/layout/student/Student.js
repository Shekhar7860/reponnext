...
class StudentLayout extends React.Component {
    ...
    prepearQuery = async () => {
        const { populerFilterPage, language, subject, teach_stand, search_currency, nationality, latitude, longitude, gender, keyword } = this.state
        if (keyword) {
    ...
    initialiseFilter = async (query) => {
        ...
        const items = await agent.Common.StudentFilterByTeacher(`${query}&currency=${currency}&`)
    ...
    getStudentPost = () => {
        ...
        this.state.populerFilter.forEach(res => {
            rowData.push(<div class="cursor-pointer col-md-6" onClick={() => this.goToLink(`student/${res.user_id}/request/${res.id}`)}>
                <div class="card">
                    <div class="d-flex">
                        <img class="detail-img" src={this.getProfileIcon(res.profile_image)} alt="" />
                        <div class="card-body">
                            <div class="d-flex flex-column">
                                ...
                                <div>
                                    ...
                                    <span class="text-third text-secondary">{capitalizeFirstLetter(res.first_name)} {capitalizeFirstLetter(res.last_name)}</span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    render() {
        ...
        return <section>
            <div class={styles.studentBanner}>
                <img class="slides-img" src="/images/student_page/student_banner_one.png" />
                <img class="slides-img" src="/images/student_page/student_banner_two.png" />
                <img class="slides-img" src="/images/student_page/student_banner_three.png" />
                <div class="container z1">
                    <div class="row justify-content-between align-items-center">
                        <div class="col-lg-4 col-md-6">
                            <h1 class="banner-heading">Become the best<br /> <span class="text-primary fw-700">Teachers.</span></h1>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                            <button type="button" class="btn btn-primary btn-round px-5 py-2" onClick={() => this.goToLink("create-request")}>Create Request</button>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-3 pt-3">
                        <div class="card">
                            <div class="card-body">
                                ...
                                {/* <input type="text" className="form-control pt-0 mb-1" ref={this.placeInputRef} onChange={(e) => (e.target.value === "") ? this.resetAddress() : () => { }} /> */}
                        ...
                        {(populerFilterCount !== 0) ?
                            <div class="card card-section mb-0">
                                <div class="card-body pb-0">
                                    <h5 class="sub-heading mb-4 space-nowrap">Student's Request</h5>
                                    <div class="row">
                                        {this.getStudentPost()}
                                    </div>
                                </div>
